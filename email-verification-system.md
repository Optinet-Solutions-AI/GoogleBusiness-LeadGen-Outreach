...
| `SMTP_PROBE_HELO` | Optional | `rateupdigital.com` | HELO domain for the stage-4 probe — must be a real domain we own |
| `SMTP_PROBE_FROM` | Optional | `verify@rateupdigital.com` | MAIL FROM for the stage-4 probe — any deliverable address on the HELO domain |
